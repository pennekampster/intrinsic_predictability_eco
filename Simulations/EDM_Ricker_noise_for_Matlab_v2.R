...
data <-readMat(here::here("Simulations", 'RickerTimeSeriesData.mat')) #Get time series data from Matlab
...
output$noise_level <- gsub("RM.", "", output$noise_level)
...
writeMat(here::here("Simulations", "Ricker_Forecast_Error.mat"), output=output)
